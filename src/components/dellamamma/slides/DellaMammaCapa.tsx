  ...
  return (
    <div className="relative min-h-screen bg-[#1B2A4A] flex flex-col justify-between px-6 py-8 md:px-16 md:py-12 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
        ...
        <motion.h1
          {...fadeUp(0.4)}
          className="font-montserrat font-black text-[32px] md:text-[56px] text-[#F2F2F2] leading-tight mb-4"
        >
        ...
        >
          Uma análise completa de como a pizzaria mais avaliada de Vitória da Conquista aparece (ou não) na internet.
        </motion.p>
        ...
        >
          Av. São Geraldo, 1438 — Alto Maron, Vitória da Conquista/BA
        </motion.p>
